...
class Settings(BaseSettings):
    ...
    VERSION: str = "0.1.0"
    DATABASE_URI: str = f"postgresql://{os.environ['DATABASE_USERNAME']}:{os.environ['DATABASE_PASSWORD']}@{os.environ['DATABASE_HOST']}/{os.environ['DATABASE_NAME']}?sslmode=require"
